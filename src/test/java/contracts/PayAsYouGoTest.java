...
public class PayAsYouGoTest {
	...
	String contracrtTypeButtonSelector, contractNameSelector, paymentSelector, clauseSelector, createButtonSelector,
			nextButtonSelector;
	...
	void goToCreate() {
		...
		contracrtTypeButtonSelector = "a[class='anchor heap-start-payg-contract'] div[class='box text-center height-100 contract-selector']";
	...
	void selectContractType() {
		...
		assertEquals("https://app.letsdeel.com/create/pay-as-you-go", driver.getCurrentUrl());
	}
